export default function SystemHealthComingSoon() {
  return (
    <div className="w-full flex items-center justify-center min-h-[60vh]">
      <div className="glass-card rounded-2xl p-12 text-center max-w-lg slide-up border border-gray-200">
        <div className="text-6xl mb-6 float">⚙️</div>
        <h1 className="text-4xl font-bold gradient-text mb-4">System Health</h1>
